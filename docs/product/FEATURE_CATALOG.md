...
|---|---|---|---|---|---|
| F-MAPS-002 | Maps / layers, click inspection and spatial context | `BETA` | Verified boundary/assets/layers with source/date. | Layer is not evidence alone; tenant map reads stay authorized. OpenFreeMap visual context is provider-configured and is not analytical evidence. | Pilot map; [Farm360](../geospatial/FARM_360_V1.md). |
