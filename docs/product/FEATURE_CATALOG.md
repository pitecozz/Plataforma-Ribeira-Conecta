...
| F-ASSET-002 | Asset context, click/detail and infrastructure inventory | `BETA` | Persisted Digital Twin assets/geometry/source/context. | No inferred equipment/condition; `asset:read` and RLS. Close markers group only in the current display and disclose every stored asset. | Pilot P0; [Farm360](../geospatial/FARM_360_V1.md). |
