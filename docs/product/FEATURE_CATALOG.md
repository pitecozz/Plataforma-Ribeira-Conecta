...
|---|---|---|---|---|---|
| F-CORE-001 | Tenant Digital Twin / Maps / Farm360 | `FOUNDATION` | Operator and customer representation of property and physical assets. | Property/asset geometry, ownership, source, timestamps; PostGIS/RLS. | Manual facts stay `MANUAL_CONFIRMED`; no inferred equipment. Inventory is `asset:read`-gated and Farm360 registration is separately `asset:manage`-gated; broader rule asset scope remains pending. |
