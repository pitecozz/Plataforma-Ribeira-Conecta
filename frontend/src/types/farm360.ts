...
export interface ProcessingJob { id: string; job_type: string; status: string; failure_reason: string | null; output_product_id: string | null; created_at: string; started_at: string | null; finished_at: string | null; }
