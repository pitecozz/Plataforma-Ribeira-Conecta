...
describe("NDVI metadata", () => { it("shows persisted statistics without inventing missing values", () => { render(<NdviPanel product={product} />); expect(screen.getByText("0.1 / 0.8 / 0.4")).toBeInTheDocument(); expect(screen.getByText("12 / 3")).toBeInTheDocument(); }); });
