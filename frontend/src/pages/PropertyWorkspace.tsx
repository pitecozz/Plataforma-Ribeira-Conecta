...
export function PropertyWorkspace({ api, apiBaseUrl, tenantId, token, initialPropertyId, canManageProperties = false, canManageBoundary = false, canRunSatelliteOperations = false, canManageAssets = false, canCompleteActions = false, canEvaluateAssets = false, canEvaluateFields = false, canEvaluateTemporalDelta = false }: { api: Farm360Api; apiBaseUrl: string; tenantId: string; token: string; initialPropertyId?: string; canManageProperties?: boolean; canManageBoundary?: boolean; canRunSatelliteOperations?: boolean; canManageAssets?: boolean; canCompleteActions?: boolean; canEvaluateAssets?: boolean; canEvaluateFields?: boolean; canEvaluateTemporalDelta?: boolean; }) {
