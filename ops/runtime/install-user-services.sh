...
systemctl --user enable ribeira-api.service ribeira-geospatial-worker.service ribeira-frontend.service
printf '%s\n' 'installed and enabled user services; use systemctl --user start ribeira-api ribeira-geospatial-worker ribeira-frontend'
